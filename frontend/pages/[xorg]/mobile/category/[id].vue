<template>
    <LazyFormCategory :_id="_id" class="w-full" @after="after"/>
</template>
...
const doc = useNuxtApp().$CategoryDoc()
const _id = getPathPara('id','')

const after = (actionName: string, data: Category) => {    
  console.log("Category capture after emits ", actionName)
  switch (actionName) {
    case "exit":
      goTo(doc.getDocName());
      break;
