<template>
    <LazyFormTenant :_id="_id" class="w-full" @after="after"/>
</template>
...
const doc = useNuxtApp().$TenantDoc()
const _id = getPathPara('id','')

const after = (actionName: string, data: Tenant) => {    
  console.log("Tenant capture after emits ", actionName)
  switch (actionName) {
    case "exit":
      goTo(doc.getDocName());
      break;
