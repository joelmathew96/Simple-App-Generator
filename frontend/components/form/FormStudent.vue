...
<template>    
    <div>
            ...
            <title v-if="id">{{ data.studentName }}</title>
    ...
    <SimpleAppForm #default="o" :document="doc">                    
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 p-2">
                                        ...
                                        <SimpleAppInput :input-type="SimpleAppInputType.text"  :setting="o.getField('#/properties/studentName')" v-model="data.studentName" />            
                                                                                        ...
                                                                                        <SimpleAppInput :input-type="SimpleAppInputType.text"  :setting="o.getField('#/properties/email2')" v-model="data.email2"type="email" />            
 ...
 */
 ...
 import { Student } from "~/simpleapp/generate/types";
import { StudentDoc} from "~/simpleapp/docs/StudentDoc"


 const props = defineProps<{ _id?: string, doc?: StudentDoc , paras?:Student}>();
 const doc = props.doc ??  useNuxtApp().$StudentDoc()
